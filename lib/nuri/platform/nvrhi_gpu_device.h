...
class NvrhiGPUDevice final : public GPUDevice {
public:
  static std::unique_ptr<NvrhiGPUDevice>
  create(Window &window, const GPUDeviceCreateDesc &desc = {});
  ~NvrhiGPUDevice() override;

  NvrhiGPUDevice(const NvrhiGPUDevice &) = delete;
  NvrhiGPUDevice &operator=(const NvrhiGPUDevice &) = delete;
  NvrhiGPUDevice(NvrhiGPUDevice &&) = delete;
  NvrhiGPUDevice &operator=(NvrhiGPUDevice &&) = delete;
...
private:
  NvrhiGPUDevice();
  std::unique_ptr<NvrhiGPUDeviceImpl> impl_;
};
