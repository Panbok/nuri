...
enum class TextureArtifactTarget : uint8_t { BC7, ETC2, RGBA8 };
...
[[nodiscard]] NURI_API Format resolveTextureArtifactTargetFormat(
    TextureArtifactTarget target, bool srgb, uint32_t componentCount) noexcept;
