...
constexpr std::array kCatalog{
    ...
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_volume0_irradiance_atlas",
        .kind = RenderCaptureValueKind::LinearHdrColor,
        .lifetime = RenderCaptureLifetimeClass::FeaturePersistentTexture,
        .defaultCompareProfile = "hdr_color",
    ...
    SnapshotCaptureCatalogEntry{
        ...
        .producer = "DDGIFeature",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea = "committed DDGI volume slot 0 distance atlas",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_volume1_irradiance_atlas",
        .kind = RenderCaptureValueKind::LinearHdrColor,
        .lifetime = RenderCaptureLifetimeClass::FeaturePersistentTexture,
        .defaultCompareProfile = "hdr_color",
        .producer = "DDGIFeature",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea = "committed DDGI volume slot 1 irradiance atlas",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_volume1_distance_atlas",
        .kind = RenderCaptureValueKind::Scalar,
        .lifetime = RenderCaptureLifetimeClass::FeaturePersistentTexture,
        .defaultCompareProfile = "scalar",
        .producer = "DDGIFeature",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea = "committed DDGI volume slot 1 distance atlas",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_volume2_irradiance_atlas",
        .kind = RenderCaptureValueKind::LinearHdrColor,
        .lifetime = RenderCaptureLifetimeClass::FeaturePersistentTexture,
        .defaultCompareProfile = "hdr_color",
        .producer = "DDGIFeature",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea = "committed DDGI volume slot 2 irradiance atlas",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_volume2_distance_atlas",
        .kind = RenderCaptureValueKind::Scalar,
        .lifetime = RenderCaptureLifetimeClass::FeaturePersistentTexture,
        .defaultCompareProfile = "scalar",
        .producer = "DDGIFeature",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea = "committed DDGI volume slot 2 distance atlas",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_volume3_irradiance_atlas",
        .kind = RenderCaptureValueKind::LinearHdrColor,
        .lifetime = RenderCaptureLifetimeClass::FeaturePersistentTexture,
        .defaultCompareProfile = "hdr_color",
        .producer = "DDGIFeature",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea = "committed DDGI volume slot 3 irradiance atlas",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_volume3_distance_atlas",
        .kind = RenderCaptureValueKind::Scalar,
        .lifetime = RenderCaptureLifetimeClass::FeaturePersistentTexture,
        .defaultCompareProfile = "scalar",
        .producer = "DDGIFeature",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea = "committed DDGI volume slot 3 distance atlas",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_volume4_irradiance_atlas",
        .kind = RenderCaptureValueKind::LinearHdrColor,
        .lifetime = RenderCaptureLifetimeClass::FeaturePersistentTexture,
        .defaultCompareProfile = "hdr_color",
        .producer = "DDGIFeature",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea = "committed DDGI volume slot 4 irradiance atlas",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_volume4_distance_atlas",
        .kind = RenderCaptureValueKind::Scalar,
        .lifetime = RenderCaptureLifetimeClass::FeaturePersistentTexture,
        .defaultCompareProfile = "scalar",
        .producer = "DDGIFeature",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea = "committed DDGI volume slot 4 distance atlas",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_volume5_irradiance_atlas",
        .kind = RenderCaptureValueKind::LinearHdrColor,
        .lifetime = RenderCaptureLifetimeClass::FeaturePersistentTexture,
        .defaultCompareProfile = "hdr_color",
        .producer = "DDGIFeature",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea = "committed DDGI volume slot 5 irradiance atlas",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_volume5_distance_atlas",
        .kind = RenderCaptureValueKind::Scalar,
        .lifetime = RenderCaptureLifetimeClass::FeaturePersistentTexture,
        .defaultCompareProfile = "scalar",
        .producer = "DDGIFeature",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea = "committed DDGI volume slot 5 distance atlas",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_volume6_irradiance_atlas",
        .kind = RenderCaptureValueKind::LinearHdrColor,
        .lifetime = RenderCaptureLifetimeClass::FeaturePersistentTexture,
        .defaultCompareProfile = "hdr_color",
        .producer = "DDGIFeature",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea = "committed DDGI volume slot 6 irradiance atlas",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_volume6_distance_atlas",
        .kind = RenderCaptureValueKind::Scalar,
        .lifetime = RenderCaptureLifetimeClass::FeaturePersistentTexture,
        .defaultCompareProfile = "scalar",
        .producer = "DDGIFeature",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea = "committed DDGI volume slot 6 distance atlas",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_volume7_irradiance_atlas",
        .kind = RenderCaptureValueKind::LinearHdrColor,
        .lifetime = RenderCaptureLifetimeClass::FeaturePersistentTexture,
        .defaultCompareProfile = "hdr_color",
        .producer = "DDGIFeature",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea = "committed DDGI volume slot 7 irradiance atlas",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_volume7_distance_atlas",
        .kind = RenderCaptureValueKind::Scalar,
        .lifetime = RenderCaptureLifetimeClass::FeaturePersistentTexture,
        .defaultCompareProfile = "scalar",
        .producer = "DDGIFeature",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea = "committed DDGI volume slot 7 distance atlas",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_volume4_irradiance_atlas",
        .kind = RenderCaptureValueKind::LinearHdrColor,
    ...
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_debug_preview",
        .kind = RenderCaptureValueKind::DebugPreview,
        .lifetime = RenderCaptureLifetimeClass::FrameSharedRingTexture,
        .defaultCompareProfile = "debug_preview",
        .producer = "DDGIFeature",
        .coverageArea = "DDGI selected debug preview",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_coverage_debug_preview",
        .kind = RenderCaptureValueKind::DebugPreview,
        .defaultCompareProfile = "debug_preview",
        .producer = "DDGIFeature coverage query",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea =
            "effective DDGI coverage, selected slots, and sky remainder",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_classification_debug_preview",
        .kind = RenderCaptureValueKind::DebugPreview,
        .defaultCompareProfile = "debug_preview",
        .producer = "DDGIFeature classification query",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea = "submitted DDGI probe classification confidence",
    },
    SnapshotCaptureCatalogEntry{
        .name = "ddgi_dirty_region_debug_preview",
        .kind = RenderCaptureValueKind::DebugPreview,
        .defaultCompareProfile = "debug_preview",
        .producer = "DDGIFeature dirty response query",
        .version = kDDGICaptureSemanticsVersion,
        .coverageArea = "localized DDGI response through submitted update age",
    },
};
