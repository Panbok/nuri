...
void beginHtmlReport(std::ostream &out, std::string_view title,
  ...
  out << "<!doctype html><html lang=\"en\"><head><meta charset=\"utf-8\">"
      ...
      << htmlEscape(title)
      << "</title><script>try{const "
         "t=localStorage.getItem('nuri-report-theme');"
         "if(t)document.documentElement.dataset.theme=t}catch(_){}</"
         "script><style>"
      << kReportCss << additionalCss
      << "</style></head><body><a class=\"skip-link\" href=\"#main-content\">"
         "Skip to report content</a><div id=\"report-announcer\" "
         "class=\"sr-only\" "
...
void endHtmlReport(std::ostream &out, std::string_view additionalScript) {
  out << "<footer class=\"report-footer\">Generated by Nuri renderer tooling. "
         "This report is self-contained and works "
         "offline.</footer></div><script>"
